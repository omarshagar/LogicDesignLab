...
public class BitVisualizer implements component{
   ...
   BitVisualizer(BreadBoard mainBoard, JPanel MainFrame) {
       ...
       lab=new JLabel();
         ...
         lab.setIcon(new javax.swing.ImageIcon(getClass().getResource("0.png")));
  ...
  public void  add(int row,int col) throws IOException
  {
    ...
    public void pinchanged(int x, int y) {
        if(this.pin.getValue()>0) lab.setIcon(new javax.swing.ImageIcon(getClass().getResource("1.png")));
                else  lab.setIcon(new javax.swing.ImageIcon(getClass().getResource("0.png")));
    }
