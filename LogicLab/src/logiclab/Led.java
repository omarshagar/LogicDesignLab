...
public class Led implements component{
    ...
    Led(BreadBoard mainBoard, JPanel MainFrame) {
  ...
  public void  add(int row,int col) throws IOException
  {
    ...
    public void pinchanged(int x, int y) {
        if(this.pin.getValue()>0) lab.setIcon(new javax.swing.ImageIcon(getClass().getResource("light.png")));
                else  lab.setIcon(new javax.swing.ImageIcon(getClass().getResource("dark.png")));
    }
